...
#include "VillagerEnemyAIController.generated.h"
 ...
 */
UCLASS()
class PROPHECY_API AVillagerEnemyAIController : public AAIController
{
	GENERATED_BODY()
